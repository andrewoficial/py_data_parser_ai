...
//    #include <ntdef.h>
    ...
    struct HidDllFunctions
    {
        ...
        UINT (WINAPI *GetCaps)(void*, HIDP_CAPS*);
...
class HidDeviceList : public std::vector<HidDeviceDescr> {};
...
class HidDevice
{
    ...
    public:
         ...
         */
        bool            open(bool bBackgroundReader);
        ...
        {
            readFifoBuffer = std::queue<std::string>();
        }
         ...
         */
        int             write(BYTE * arr,UINT nSize)              const;
        ...
        unsigned short getReadBufferSize() const;
        CEvent* evBreak;
...
class HidApi
{
    private:
        ...
        void                              (*deviceAddCallback)   (HidDeviceDescr& descr);       /*!< device added callback function's pointer. */
        void                              (*deviceRemoveCallback)(std::string& path);       /*!< device removed callback function's pointer. */
    ...
    public:
         ...
         */
                            HidApi(void (*apiErrCb)(HidError) = NULL, unsigned short _vendorId = ANY, unsigned short _productId = ANY);
         ...
         */
        void                registerDeviceAddCallback(void (*fptr)(HidDeviceDescr& path));

        /*!
         * Saves the function pointer to HidApi::deviceRemoveCallback member variable. Function prototype
         * must be like this: void func_name(int index, HidDevice dev);
         */
        void                registerDeviceRemoveCallback(void (*fptr)(std::string& path));
